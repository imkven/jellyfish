...
// @TODO: change to CUpdateMasternode and UpdateMasternode
...
export class UpdateMasternodeIndexer extends DfTxIndexer<UpdateMasternode> {
  ...
  private readonly logger = new Logger(UpdateMasternodeIndexer.name)
  ...
  async indexStats (block: RawBlock, data: UpdateMasternode, collateral: BigNumber): Promise<void> {
